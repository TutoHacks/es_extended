Locales['de'] = {
  ...
  ['threw_standard'] = 'Du wirfst folgendes weg: ~y~%sx~s~ ~b~%s~s~',
  ['threw_money'] = 'Du wirfst folgendes weg: ~r~$%s~s~ ~b~$~s~',
  ['threw_account'] = 'Du wirfst folgendes weg: ~r~$%s~s~ ~b~%s~s~',
  ['threw_weapon'] = 'Du wirfst folgendes weg: ~b~%s~s~',
  ['threw_weapon_ammo'] = 'Du wirfst folgendes weg: ~b~%s~s~ with ~o~%sx~s~ bullets',
  -- Salary related
  ['received_salary'] = 'du hast deinen stündlichen Lohn erhalten: ~g~$%s~s~',
